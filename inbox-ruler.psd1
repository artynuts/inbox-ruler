@{
    ...
    FunctionsToExport = @('Connect-ToExchange', 'Get-InboxRules', 'New-CustomInboxRule', 'Remove-CustomInboxRule', 'Rename-CustomInboxRule', 'New-MailboxFolderHierarchy', 'Test-InboxRuleHygiene', 'Get-InboxRuleDescription')
    CmdletsToExport = @()
    VariablesToExport = '*'
    AliasesToExport = @()
    PrivateData = @{
