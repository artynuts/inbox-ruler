@{
    ...
    FunctionsToExport = @('Connect-ToExchange', 'Get-InboxRules', 'New-CustomInboxRule', 'Remove-CustomInboxRule', 'Rename-CustomInboxRule', 'New-MailboxFolderHierarchy', 'Test-InboxRuleHygiene')
    CmdletsToExport = @()
    VariablesToExport = '*'
    AliasesToExport = @()
    PrivateData = @{
